...
if(isset($_REQUEST['username'])){ $username=$_REQUEST['username']; $update_user = $update_user . "username='$username', ";   }

if(isset($_REQUEST['first_name'])){ $first_name=$_REQUEST['first_name']; $update_user= $update_user . "first_name='$first_name',"; }
if(isset($_REQUEST['last_name'])){ $last_name=$_REQUEST['last_name']; $update_user= $update_user . "last_name='$last_name',"; }
if(isset($_REQUEST['address'])){ $address=$_REQUEST['address']; $update_user= $update_user . "address='$address',";}
...
if(isset($_REQUEST['password'])){
        ...
        $update_user = $update_user . "Where id =$user_id "; 
			...
			$run_update=mysqli_query($sql,$update_user);
			 ...
			 $result['status']='0';
			$result['error']='Customer Information Is Not Updated';
	}
