...
public function get_member_list_for_message()
{
	...
	{
		$roles = ["member"=>__("Members"),"staff_member"=>__("Trainer"),"accountant"=>__("Accountants")];
	}else{
		$roles = ["member"=>__("Members"),"staff_member"=>__("Trainer"),"accountant"=>__("Accountants"),"administrator"=>__("Administrator")];
	}
