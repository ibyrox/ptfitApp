...
class GymAccessrightController extends AppController
{
	public function accessRight()
    {
		...
		{			
			...
			//---------NEW MENU LINK START------------------ 
			$access_right['staff_member'] = array('menu_icone'=>'staff-member.png' ,'menu_title'=>'Trainer',	
			...
			//////////////////////////////////////////////////////////// YP STARTS HERE ///////////////////////////////////////////////////////////////
			//---------NEW MENU LINK START------------------
			$access_right['category'] =array('menu_icone'=>'workout.png' ,'menu_title'=>'Workout Category',
			    'member' => isset($request['member_category'])?$request['member_category']:0,
			    'action'=>'',
			    'staff_member' =>isset($request['staff_member_category'])?$request['staff_member_category']:0,
			    'accountant' =>isset($request['accountant_category'])?$request['accountant_category']:0,
			    'page_link'=>$site_path.'/category/category-list',
			    'controller'=>"Category");
			
			//---------NEW MENU LINK START------------------
			$access_right['exercise'] =array('menu_icone'=>'workout.png' ,'menu_title'=>'Exercise',
			    'member' => isset($request['member_exercise'])?$request['member_exercise']:0,
			    'action'=>'',
			    'staff_member' =>isset($request['staff_member_exercise'])?$request['staff_member_exercise']:0,
			    'accountant' =>isset($request['accountant_exercise'])?$request['accountant_exercise']:0,
			    'page_link'=>$site_path.'/gym-exercise/exercise-list',
			    'controller'=>"Exercise");
			
			//---------NEW MENU LINK START------------------
			/* $access_right['mod'] =array('menu_icone'=>'workout.png' ,'menu_title'=>'Mod',
			    'member' => isset($request['member_mods'])?$request['member_mods']:0,
			    'action'=>'',
			    'staff_member' =>isset($request['staff_member_mods'])?$request['staff_member_mods']:0,
			    'accountant' =>isset($request['accountant_mods'])?$request['accountant_mods']:0,
			    'page_link'=>$site_path.'/mod/mod-list',
			    'controller'=>"Mod"); */
			////////////////////////////////////////////////////////// YP Ends Here ///////////////////////////////////////////////////////////////
