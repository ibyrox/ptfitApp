...
<div class="form">
 ...
 <!-- <form class="register-form">
  ...
  <?php //echo $this->Form->create(["class"=>"login-form","method"=>"post","action"=>"GymLogin/index"]);?>
   ...
   <p class="message"><a href="<?php echo $this->request->base;?>/MemberRegistration/clientRegistration"><?php echo __("Client Registration");?></a>
   <p class="message"><a href="<?php echo $this->request->base;?>/MemberRegistration/trainerRegistration"><?php echo __("Trainer Registration");?></a>
   
   <p class="message"><a href="<?php echo $this->request->base;?>/ForgetPassword/"><?php echo __("Forget Password?");?></a>
