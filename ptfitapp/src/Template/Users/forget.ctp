...
<div class="form">
 ...
 <!-- <form class="register-form">
  ...
  <?php //echo $this->Form->create(["class"=>"login-form","method"=>"post","action"=>"GymLogin/index"]);?>
    <input type="text" placeholder="<?php echo __("New Password");?>" name="password" />
    <input type="password" placeholder="<?php echo __("Confirm Password");?>" name="confirmpassword"/>
    <button id="btn_login"><?php echo __("Login");?></button>
   <p class="message"><a href="<?php echo $this->request->base;?>/MemberRegistration/"><?php echo __("Client Registration");?></a>
   
   <p class="message"><a href="<?php echo $this->request->base;?>/MemberRegistration/?t=trn"><?php echo __("Trainer Registration");?></a>
   
   <p class="message"><a href="<?php echo $this->request->base;?>/users/forget/"><?php echo __("Forget Password?");?></a>
