	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Gym->createurl("GymLevels","addLevel");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Add Level");?></a>
			  </ol>
			<?php } ?>
			</section>
		</div>
		...
		<table class="mydataTable table table-striped">
			...
			<tbody>
				...
				foreach($data as $row) {
					...
					echo  "<td>
								<a href='{$this->request->base}/GymLevels/editLevel/{$row['id']}' title='Edit' class='btn btn-flat btn-primary'><i class='fa fa-edit'></i></a>
								<a href='{$this->request->base}/GymLevels/deleteLevel/{$row['id']}' title='Delete' class='btn btn-flat btn-danger' onClick=\"return confirm('Are you sure,You want to delete this record?');\"><i class='fa fa-trash-o'></i></a>						
							</td>					
					</tr>";
				}
			?>
