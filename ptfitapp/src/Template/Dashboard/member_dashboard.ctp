...
<div id="main-wrapper">		
				...
				<div class="panel info-box panel-white">
					<div class="panel-body member">
						...
						<div class="info-box-stats">
							<p class="counter"><?php echo $members;?> <span class="info-box-title"><?php echo __("Client");?></span></p>
						</div>
					</div>
				</div>
			</a>
			...
			<a href="<?php echo $this->request->base ."/staff-members/staff-list";?>">
				<div class="panel info-box panel-white">
					<div class="panel-body staff-member">
                        ...
                        <div class="info-box-stats">
							<p class="counter"><?php echo $staff_members;?><span class="info-box-title"><?php echo __("Trainer");?></span></p>
						</div>
					</div>
				</div>
				</a>
		...
		<div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
			<a href="<?php echo $this->request->base ."/gym-assign-workout/member-assiged-workout";?>">
				<div class="panel info-box panel-white">
					<div class="panel-body group">
						<img src="<?php echo $this->request->base;?>/webroot/img/dashboard/member.png" class="dashboard_background">
						<div class="info-box-stats groups-label">
							<p class="counter"><!--<?php echo $groups;?>--><span class="info-box-title"><?php echo __("Assigned Workout");?></span></p>
						</div>
