	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  <h3 id='form-head'>
				...
				<?php 
				if($member_type == 'TR'){
					echo __("Trainer Registration");	
				}else{
					echo __("Member Registration");
				}
				?>
			  </h3>			  
			</section>
		...
		<?php				
			...
			*/
			...
			echo $this->Form->button(__('Register'),['class'=>"col-md-offset-2 btn btn-flat btn-success","name"=>"add_member"]);
			echo "</div>";
