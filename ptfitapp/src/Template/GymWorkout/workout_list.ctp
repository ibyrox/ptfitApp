	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Gym->createurl("GymWorkout","addWorkout");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Add Workout");?></a>
			  </ol>
			<?php } ?>
			</section>
		</div>
		...
		<table class="mydataTable table table-striped">
			<thead>
				<tr>
					...
					<th><?php echo __("Rest Time (min)");?></th>
					<?php 
