		...
		<div class="box-header">
			<section class="content-header">
			  ...
			  <?php
				...
				{ ?>
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Gym->createurl("StaffMembers","addStaff");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Add Trainer");?></a>
			  </ol>
			  <?php } ?>
			</section>
		</div>
		...
		<table class="mydataTable table table-striped">
			<thead>
				<tr>
					...
					<th><?php echo __("Trainer Email");?></th>					
