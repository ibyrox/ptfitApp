...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">			
			  <h1>		
				...
				<?php echo $title;?>
				<small><?php echo __("Trainer");?></small>
			  </h1>
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Gym->createurl("StaffMembers","StaffList");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Trainer List");?></a>
			  </ol>
			</section>
		</div>
		<hr>
		<div class="box-body">			
			...
			echo $this->Form->button(__("Save Trainer"),['class'=>"btn btn-flat btn-primary","name"=>"add_group"]);
			echo $this->Form->end();
			?>				
		</div>	
