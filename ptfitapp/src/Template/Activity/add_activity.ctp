...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class='form-group'>
			<label class="control-label col-md-2" for="email"><?php echo __("Activity Title");?><span class="text-danger"> *</span></label>
			<div class="col-md-6">
				<?php 
		...
		<?php } ?>
		<div class='form-group'>
			<label class="control-label col-md-2" for="email"><?php echo __("Select Membership");?><span class="text-danger"> *</span></label>
			<div class="col-md-6">
				<?php 
