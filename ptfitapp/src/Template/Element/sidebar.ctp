<?php $session = $this->request->session(); ?>
     ...
     <!-- <form action="#" method="get" class="sidebar-form">
          ...
          <!-- <li class="header">MAIN NAVIGATION</li> -->		 
              ...
              <a href="<?php echo $this->Gym->createurl("GymMember","memberList");?>">
			   ...
			   <ul class="treeview-menu">
					<li class="<?php echo ($this->request->action == "memberList" || $this->request->action == "addMember" || $this->request->action == "editMember" || $this->request->action == "viewMember") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("GymMember","memberList");?>"><i class="fa fa-circle-o"></i><?php echo __('Client');?></a>
					</li>
					<li class="<?php echo ($this->request->action == "staffList" || $this->request->action == "addStaff") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("StaffMembers","StaffList");?>">
							<i class="fa fa-circle-o"></i><span><?php echo __('Trainer');?></span></i>
						</a>
					</li>
			...
			<li class="treeview <?php echo ($this->request->controller == "GymCategory") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymCategory","categoryList");?>">
                <i class="fa fa-bicycle"></i> <span><?php echo __('Category');?></span>  
              </a>
			</li>
			
			<li class="treeview <?php echo ($this->request->controller == "GymMod") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymMod","modList");?>">
                <i class="fa fa-bicycle"></i> <span><?php echo __('Mod');?></span>  
              </a>
			</li>
				
			<li class="treeview <?php echo ($this->request->controller == "GymExercise") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymExercise","exerciseList");?>">
                <i class="fa fa-bicycle"></i> <span><?php echo __('Exercise');?></span>  
              </a>
			</li>
