...
<form name="student_form" action="" method="post" class="form-horizontal" id="access_right_form">
		...
		<div class="col-md-2 col-sm-3 col-xs-3"><?php echo __("Trainer");?></div>
		...
		<div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5">
				<span class="menu-label">
					<?php echo __("Category");?>				</span>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($member["category"])?"checked":"";?> value="1" name="member_category" readonly="">	              
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($staff_member["category"])?"checked":"";?> value="1" name="staff_member_category" readonly="">	              
					</label>
				</div>
			</div>
			...
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($accountant["category"])?"checked":"";?> value="1" name="accountant_category" readonly="">	              
					</label>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5">
				<span class="menu-label">
					<?php echo __("Excersize");?>				</span>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($member["excersize"])?"checked":"";?> value="1" name="member_excersize" readonly="">	              
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($staff_member["excersize"])?"checked":"";?> value="1" name="staff_member_excersize" readonly="">	              
					</label>
				</div>
			</div>
			...
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($accountant["excersize"])?"checked":"";?> value="1" name="accountant_excersize" readonly="">	              
					</label>
				</div>
			</div>
		</div>
		...
		<!--   <div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5">
				<span class="menu-label">
					<?php echo __("Mod");?>				</span>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($member["mod"])?"checked":"";?> value="1" name="member_mod" readonly="">	              
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($staff_member["mod"])?"checked":"";?> value="1" name="staff_member_mod" readonly="">	              
					</label>
				</div>
			</div>
			...
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($accountant["mod"])?"checked":"";?> value="1" name="accountant_mod" readonly="">	              
					</label>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5">
				<span class="menu-label">
					<?php echo __("Workout");?>				</span>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($member["workout"])?"checked":"";?> value="1" name="member_workout" readonly="">	              
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($staff_member["workout"])?"checked":"";?> value="1" name="staff_member_workout" readonly="">	              
					</label>
				</div>
			</div>
			...
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($accountant["workout"])?"checked":"";?> value="1" name="accountant_workout" readonly="">	              
					</label>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5">
				<span class="menu-label">
					<?php echo __("Program Workout Schedule");?>				</span>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($member["program-workout-schedule"])?"checked":"";?> value="1" name="member_program_workout_schedule" readonly="">	              
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($staff_member["program-workout-schedule"])?"checked":"";?> value="1" name="staff_member_program_workout_schedule" readonly="">	              
					</label>
				</div>
			</div>
			...
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($accountant["program-workout-schedule"])?"checked":"";?> value="1" name="accountant_program_workout_schedule" readonly="">	              
					</label>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5">
				<span class="menu-label">
					<?php echo __("Workout Assignment");?>				</span>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($member["workout-assignment"])?"checked":"";?> value="1" name="member_workout_assignment" readonly="">	              
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($staff_member["workout-assignment"])?"checked":"";?> value="1" name="staff_member_workout_assignment" readonly="">	              
					</label>
				</div>
			</div>
			...
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($accountant["workout-assignment"])?"checked":"";?> value="1" name="accountant_workout_assignment" readonly="">	              
					</label>
				</div>
			</div>
		</div>
